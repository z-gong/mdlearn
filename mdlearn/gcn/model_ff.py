...
class MultiHeadEdgeGATLayer(nn.Module):
    ...
    def forward(self, g, feats_node, feats_edge):
        ...
        return torch.cat(ndata, dim=1), torch.cat(edata, dim=1)
...
class ForceFieldGATModel(nn.Module):
    def __init__(self, in_dim_node, in_dim_edge, in_dim_graph, out_dim, n_head):
        ...
        self.gat2 = MultiHeadEdgeGATLayer(out_dim * n_head, in_dim_edge * n_head, out_dim, n_head)
        self.gat3 = MultiHeadEdgeGATLayer(out_dim * n_head, in_dim_edge * n_head, out_dim, 1)
